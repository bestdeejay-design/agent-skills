...
> **Цель:** справочник по направлениям экосистемы и ориентир для развития библиотеки `agent-skills` (51 скиллов).
>
...
- позиционирования наших 51 скиллов относительно индустрии;
