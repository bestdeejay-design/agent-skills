...
> **Цель:** справочник по направлениям экосистемы и ориентир для развития библиотеки `agent-skills` (52 скиллов).
>
...
- позиционирования наших 52 скиллов относительно индустрии;
...
| `commit-message-writer` | 1.1.0 | Оформление staged-изменений в Conventional Commit |
...
> Полный перечень скиллов всех категорий (`code`, `data`, `media`, `repository`, `social`, `agents`) — в `index.json`; описание каждого скилла — в его `SKILL.md`.