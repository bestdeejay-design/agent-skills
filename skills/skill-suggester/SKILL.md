...
description: "Подбор скиллов из библиотеки по задаче пользователя: какой скилл использовать, что выбрать, рекомендовать скилл, suggest skill, подобрать инструмент, какой команды, подбор скилла, рекомендация скилла, какой навык применить. Читает index.json, скорит триггеры и описания, возвращает топ-5 с релевантностью и комбо до 3 скиллов."
---
